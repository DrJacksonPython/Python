...
def (aList):#create a function called Sxx  - the parameter will be aList
    sxx = 0
    for i :#finish the for loop
         # increment sxx by (x_i - mean)^2 - you need to do this properly
    #what do you need to return

print(Sxx(aList)) # you should get 1190
