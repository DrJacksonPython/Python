...
def ( ):#create a function caled sumList - the parameter will be a list, give it a sensible name
    mySum = #set mySum to something sensible
    for i in range(, ):      #use a for loop here to add all the values to mySum - use len( ) to get the length of your list
        #put some code here to add to your mySum variable
