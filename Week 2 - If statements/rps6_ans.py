...
if user_choice == "SCISSORS" and com_choice == "PAPER": #check if the user chooses ROCK _and_ computer chooses SCISSORS
     print("You've won, well done!") #tell the user who won
elif user_choice == "SCISSORS" and com_choice == "ROCK":                      #check if the user chooses ROCK _and_ computer chooses PAPER
