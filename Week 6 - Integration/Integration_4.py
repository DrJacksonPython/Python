...
def Integration(Integrand, a, b, tol = 0.01):
    ...
    n = 1
    while abs(oldRiemannSum - newRiemannSum) > tol #make this run whilst your Riemann sums are further apart than tol and n is smaller than 5000
        oldRiemannSum = #what should I make oldRiemannSum?
        newRiemannSum = #use your RiemannSum function to evaluate a new Riemann sum
            #what MUST you do to n to stop the possibility of this being an infinite loop?!
